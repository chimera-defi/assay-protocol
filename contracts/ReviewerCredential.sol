...
/// @notice Soulbound ERC-1155 tier credential for reviewers. Non-transferable, earned through consistent correct reviews. Replaces external identity (WorldID) with protocol-native reputation.
///
/// Tiers (tokenId):
