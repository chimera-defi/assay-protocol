...
/// @title TaskEscrow
/// @notice On-chain INTEL settlement escrow. Holds buyer INTEL and releases 81/9/10 split on task acceptance. Replaces the off-chain DB ledger with verifiable on-chain token flows.
///
