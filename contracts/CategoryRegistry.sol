...
/// @notice Per-category AIU weight registry. Inspired by Bittensor DTAO subnet-specific tokens. Each task category (Code, Design, Research, Audit) has independent reward weight and performance tracking.
