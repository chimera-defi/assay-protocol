...
/// @notice Worker INTEL bond and slash-on-fraud gate. Inspired by Gensyn staking-with-slash model. Workers stake INTEL to access high-value tasks; fraudulent completions are slashable.
///
